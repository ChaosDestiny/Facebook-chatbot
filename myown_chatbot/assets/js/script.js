$(document).ready(function() {
	...
	var baseUrl = "https://lunachatbot-prj2.herokuapp.com/webhooks/rasa/webhook?token=jackfrost";
	...
	var mybot = '<div class="chatCont" id="chatCont">'+
								...
								'<div class="chatForm" id="chat-div">'+
									...
									'</div>'+
									'<input type="text" id="chat-input" autocomplete="off" placeholder="Trò chuyện cùng Luna"'+ 'class="form-control bot-txt"/>'+
								'</div>'+
							'</div><!--chatCont end-->'+
